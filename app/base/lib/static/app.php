...
class app{
    ...
    public function setConf($key, $value,$persistent=true){
        base_kvstore::config_persistent_tag();
        base_kvstore::config_persistent($persistent);
        $valOfStore = base_kvstore::instance('setting/'.$this->app_id)->store($key, $value);
        base_kvstore::config_persistent_restore();
        if($valOfStore){
