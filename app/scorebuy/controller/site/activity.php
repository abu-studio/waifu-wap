...
class scorebuy_ctl_site_activity extends b2c_frontpage{
    ...
    public function __construct(&$app){
        ...
        if(isset($shopname)){
            ...
            $this->keywords = app::get('b2c')->_('卖家中心').'_'.$shopname;
            $this->description = app::get('b2c')->_('卖家中心').'_'.$shopname;
        }
   ...
   public  function quitActivity($id){
        ...
        $business = $businessactivity->dump(array('id'=>$id),'gid,isMemLv,status');
