...
class aftersales_ctl_wap_member extends b2c_ctl_wap_member
{
	/**
	 * 构造方法
	...
	public function return_policy($app='',$ctl='',$act='')
    {
        ...
        $this->page('wap/member/return_policy.html',false,'aftersales');
    }
	...
	public function return_list($nPage=1)
    {
        ...
        $this->pagination($nPage, $arrPager['maxPage'], 'return_list', '', 'aftersales', 'wap_member');
        $this->page('wap/member/return_list.html',false,'aftersales');
    }
    ...
    public function seller_returns($nPage=1)
    {
        ...
        $arrPager = $this->get_start($nPage, $aData['total']);
        $this->pagination($nPage, $arrPager['maxPage'], 'return_list', '', 'aftersales', 'wap_member');
        $this->page('wap/member/seller_returns.html',false,'aftersales');
    }
	...
	public function return_order_list($nPage=1)
    {
        ...
        $this->pagination($nPage, $arrPager['maxPage'], 'return_order_list', '', 'aftersales', 'wap_member');
        $this->page('wap/member/return_order_list.html',false,'aftersales');
    }
    ...
    public function return_add_before($order_id){
        ...
        if($returns){
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'return_details','arg0'=>$returns['return_id']));
        }else{
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'return_add','arg0'=>$order_id));
        }
    }
	...
	public function return_add($order_id,$page=1)
    {
        ...
        $this->pagination($page, $arrMaxPage['maxPage'], 'return_add', array($order_id), 'aftersales', 'wap_member');
        $this->pagedata['url'] = $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'return_order_items', 'arg' => array($order_id)));
        $this->page('wap/member/return_add.html',false,'aftersales');
	...
	public function return_save()
    {
        ...
        if($order_info['status'] == 'finish'){
            ...
            {
                if($_POST['type'] == '1'){
                    $com_url = $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'gorefund_mai', 'arg0' => $_POST['order_id']));
                }else{
                    $com_url = $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'return_add', 'arg0' => $_POST['order_id']));
                }
        ...
        if($pmt_order['status'] == 'finish'){
            ...
            if($aData['safeguard_require'] == '1' || $aData['safeguard_require'] == '5'){
				...
				if(empty($_POST['product_bn'])){
					$com_url = $this->gen_url(array('app' => 'aftersales', 'ctl' => 'site_member', 'act' => 'safeguard_add', 'arg0' => $_POST['order_id']));
        ...
        if ($obj_aftersales->generate($aData, $msg))
        {
            ...
            $this->end(true, app::get('b2c')->_('提交成功！'), $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'return_list')));

        }
        else
        {
            $this->end(false, $msg, $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'return_list')));
        }
    }

	public function return_details($return_id)
    {
        $this->begin($this->gen_url(array('app' => 'b2c', 'ctl' => 'wap_member')));
        $obj_return_policy = kernel::service("aftersales.return_policy");
        $arr_settings = array();
        ...
        $this->page('wap/member/return_details.html',false,'aftersales');
    ...
    public function gorefund($order_id,$type=0)
    {
        ...
        if($tag){
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'return_products','arg0'=>$return_id));
        }else{
            if($type){
                $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'gorefund_mai','arg0'=>$order_id,'arg1'=>$type));
            }else{
                $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'gorefund_mai','arg0'=>$order_id));
            }
        }
    }
    ...
    public function return_products($return_id){
        ...
        if( !($this->pagedata['return_item']) )
        {
           $this->begin($this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'return_list')));
           $this->end(false, $this->app->_("售后服务申请单不存在！"));
        }
        $this->page('wap/member/return_products.html',false,'aftersales');
    }
    ...
    {
        if($type==3){
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'gorefund_mai_3','arg0'=>$order_id));
        }elseif($type==4){
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'gorefund_mai_4','arg0'=>$order_id));
        }
        $this->begin($this->gen_url(array('app' => 'b2c', 'ctl' => 'wap_member')));
        ...
        if ($_COOKIE['ST_ShopEx-Order-Buy'] != md5($this->app->getConf('certificate.token').$order_id) && !$is_verified)
        {
            $this->end(false,  app::get('b2c')->_('订单无效！'), array('app' => 'b2c', 'ctl' => 'wap_member'));
        }
        ...
        $this->page('wap/member/gorefund_mai.html',false,'aftersales');
    }
	...
	public function return_save_mai()
    {
        ...
        {
            if($_POST['type'] == '3'){
                $com_url = $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'gorefund_mai_3', 'arg0' => $_POST['order_id']));
            }elseif($_POST['type'] == '4'){
                $com_url = $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'gorefund_mai_4', 'arg0' => $_POST['order_id']));
            }else{
                $com_url = $this->gen_url(array('app' => 'b2c', 'ctl' => 'wap_member', 'act' => 'orders', 'arg0' => $_POST['order_id']));
            }
            $this->end(false, app::get('aftersales')->_("上传文件不能超过5M"), $com_url);
        }
        ...
        if ($obj_aftersales->generate($aData, $msg))
        {
            ...
            if($rs){
                ...
                $this->end(false,app::get('b2c')->_('提交成功！更新订单状态失败！'), $this->gen_url(array('app' => 'aftersales', 'ctl' => 'wap_member', 'act' => 'return_list')));
            }
        }
        else
        {
    ...
    public function do_gorefund($order_id){
        ...
        $this->page('wap/member/do_gorefund.html',false,'aftersales');
    }
    ...
    public function do_agree(){
        ...
        if ($obj_refunds->generate($sdf, $this, $msg))
        {
            ...
            if($is_refund_before){
				...
				$db->rollback();
                $this->splash('failed',$url,app::get('aftersales')->_('操作失败，订单更新失败。'));
            }
        }
        else
        {
    ...
    public function edit_returns($return_id){
        ...
        //echo '<pre>';print_r($this->pagedata['return_products']);exit;
        $this->page('site/member/edit_returns.html',false,'aftersales');
    }

    public function return_edit_buyer(){
        //echo '<pre>';print_r($_POST);exit;
        $this->begin(array('app' =>'b2c','ctl'=>'wap_member','act' =>'orders'));
        $aData = $_POST;
        $upload_file = "";
        if ( $_FILES['file']['size'] > 314572800 )
        {
    ...
    public function do_return($order_id,$refund_type=2){
        ...
        $this->page('site/member/do_return.html',false,'aftersales');
    }
    ...
    public function select_address(){
        if($_POST['refund_type'] == 2){
            ...
            $this->pagedata['return_id'] = $_POST['return_id'];
            $this->display('wap/member/select_address.html','aftersales');
        }else{
            $this->pagedata['return_id'] = $_POST['return_id'];
            $this->pagedata['order_id'] = $_POST['order_id'];
            ...
            $this->display('wap/member/do_agree_return.html','aftersales');
    ...
    public function do_agree_return(){
        ...
        $url = $this->gen_url(array('app' =>'b2c','ctl'=>'wap_member','act' =>'wap_member'));
        $rp = app::get('aftersales')->model('return_product');
        $objOrder = app::get('b2c')->model('orders');
    ...
    public function do_no_return(){
        ...
        $this->display('wap/member/do_no_return.html','aftersales');
    }
    //退款url
    public function send_finish($return_id){
        ///$url = ecshop/index.php/business-seller_order.html
        $url = $this->gen_url(array('app' =>'b2c','ctl'=>'wap_member','act' =>'index'));
        //$rp = aftersales_mdl_return_product
        $rp = app::get('aftersales')->model('return_product');
        //$system_money_decimals = 2
        $system_money_decimals = app::get('b2c')->getConf('system.money.decimals');
        // $system_money_operation_carryset = 0
        $system_money_operation_carryset = app::get('b2c')->getConf('system.money.operation.carryset');
        $obj_order = &$this->app->model('orders');
        //$_POST['refuse'] =0   为退款最后一部所做
        if($_POST['refuse'] == '1'){
            $returns = $rp->getRow('*',array('return_id'=>$_POST['return_id']));
    ...
    public function gorefund_select($order_id){
        ...
        if($returns){
            ...
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'return_details','arg0'=>$return['return_id']));
        }else{
            $this->pagedata['order_id'] = $order_id;
            $this->page('wap/member/do_no_return.html',false,'aftersales');
        }
    ...
    public function refund_add_buyer($order_id){
        ...
        $this->pagedata['now_time'] = time()*1000;
        $this->pagedata['order_id'] = $order_id;
        $this->page('wap/member/refund_add_buyer.html',false,'aftersales');
    }
    ...
    function edit_refund_app($order_id){
        ...
        $address['0']['region'] = $ads[1];
        $this->pagedata['address'] = $address['0'];
        $this->page('wap/member/edit_refund_app.html',false,'aftersales');
    ...
    function edit_rp(){
        ...
        $url = $this->gen_url(array('app' =>'aftersales','ctl'=>'wap_member','act' =>'return_list'));
        //处理申请单
    ...
    function edit_refund($order_id){
        ...
        $this->page('wap/member/edit_refund.html',false,'aftersales');
    }
    ...
    function edit_refund_2($order_id){
        ...
        if ($_COOKIE['ST_ShopEx-Order-Buy'] != md5($this->app->getConf('certificate.token').$order_id) && !$is_verified)
        {
            $this->end(false,  app::get('b2c')->_('订单无效！'), array('app'=>'b2c','ctl'=>'wap_member','act'=>'index'));
        }
        ...
        $this->pagedata['now_time'] = time()*1000;
        $this->pagedata['time'] = ($this->pagedata['return_item']['close_time'] + 86400*(app::get('b2c')->getConf('member.to_buyer_edit')))*1000;
        $this->page('wap/member/edit_refund_2.html',false,'aftersales');
    ...
    function s_mall_intervene(){
        ...
        $this->page('wap/member/s_mall_intervene.html',false,'aftersales');
    }
    ...
    function safeguard($order_id){
        $this->pagedata['order_id'] = $order_id;
        $this->page('wap/member/safeguard.html',false,'aftersales');

    }

    public function swith_safeguard(){
        if($_POST['is_required'] == '1'){
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'safeguard_add','arg0'=>$_POST['order_id']));
        }else{
            $this->redirect(array('app'=>'aftersales', ctl=>'wap_member','act'=>'add_safeguard','arg0'=>$_POST['order_id']));
        }
    }
    ...
    public function safeguard_add($order_id,$page=1)
    {
        ...
        $this->page('wap/member/safeguard_add.html',false,'aftersales');
    ...
    function add_safeguard($order_id){
        ...
        $this->page('wap/member/add_safeguard.html',false,'aftersales');
    }
