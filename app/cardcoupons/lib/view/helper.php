...
class cardcoupons_view_helper{
    ...
    {
        if($smarty->app->app_id != 'cardcoupons'){
            return "";
        }
        ...
        if (file_exists(app::get('cardcoupons')->app_dir.'/view/site/common/ext/'.$ext_filename))
            $smarty->pagedata['extends_header'] .= $smarty->fetch('site/common/ext/'.$ext_filename,'cardcoupons');
        /** end **/
