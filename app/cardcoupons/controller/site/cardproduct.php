...
class cardcoupons_ctl_site_cardproduct extends cardcoupons_frontpage{
    ...
    public function index() {
		...
		if($ctl_name == "site_cards1" || $ctl_name == "site_cards2"){
			$this->set_tmpl('cardex_detail1');
		}else{
			$this->set_tmpl('cardex_detail');
		}
       ...
       $this->pagedata['specShowItems'] =$specValue;
        ...
        //价格是否展示按钮
        $this->pagedata['cardsPriceFlag'] = true;		
        $this->page("site/cardproduct/{$_SESSION['sfsc']['model']}index.html");
   }
