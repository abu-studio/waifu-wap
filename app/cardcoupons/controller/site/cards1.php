...
class cardcoupons_ctl_site_cards1 extends b2c_frontpage{
    ...
    function check_card_num($card_info = array()){
        ...
        error_log("=-=-=-=card1+++-=-=-=-=-".PHP_EOL.var_export(array($kekvNamey,$tmpNum,$freezNum),1).PHP_EOL,3,DATA_DIR."/card_freeze_log.log");
    ...
    function cancelFreezKv()
    {
      foreach ($this->_cardFreezList as $key => $value) {
        ...
        error_log("=-=-=-=card1-=-=-=-=-".PHP_EOL.var_export(array($key,$savedValue),1).PHP_EOL,3,DATA_DIR."/card_freeze_log.log");
