...
class cardcoupons_ctl_admin_excards_pass_create extends desktop_controller {
	...
	function _views(){
		...
		$sub_menu = array(
            0 =>array('label'=>app::get('cardcoupons')->_('全部'),'optional'=>true,'filter'=>array('source'=>'external')),
			1 =>array('label'=>app::get('cardcoupons')->_('待审核'),'optional'=>true,'filter'=>array('source'=>'external','ex_status'=>'update')),
			2 =>array('label'=>app::get('cardcoupons')->_('审核成功'),'optional'=>true,'filter'=>array('source'=>'external','ex_status'=>'true')),
			3 =>array('label'=>app::get('cardcoupons')->_('审核失败'),'optional'=>true,'filter'=>array('source'=>'external','ex_status'=>'false')),
        );
	...
	function shenhe($id){
		$this->begin('index.php?app=cardcoupons&ctl=admin_excards_pass_create&act=index');
		if($_POST['shenhe']=='shenhe'){
			...
			$this->pagedata['id']=$id;
			$this->display('admin/excards/pass/shenhe.html');
		}
	}
}
