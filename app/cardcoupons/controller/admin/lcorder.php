<?php
class cardcoupons_ctl_admin_lcorder extends desktop_controller{
   ...
   public function index(){
	   //卡券自营店铺
        ...
        $this->finder('b2c_mdl_orders',array(
            ...
            'base_filter'=>array('order_refer'=>'local','disabled'=>'false','order_kind'=>array('b2c_card','card'),'store_id'=>$store_id_arr,'order_type|in'=>array('largeCustomer')),
    ...
    public function _views(){
        ...
        $sub_menu = array(
            0=>array('label'=>app::get('b2c')->_('全部'),'optional'=>false,'filter'=>array_merge($order_filter,array('disabled'=>'false','order_type|in'=>array('largeCustomer')))),
            1=>array('label'=>app::get('b2c')->_('未处理'),'optional'=>false,'filter'=>array_merge($order_filter,array('pay_status'=>array('0'),'ship_status'=>array('0'),'status'=>'active','disabled'=>'false','order_type|in'=>array('largeCustomer')))),
            2=>array('label'=>app::get('b2c')->_('已付款待发货'),'optional'=>false,'filter'=>array_merge($order_filter,array('pay_status'=>array('1','2','3'),'ship_status'=>array('0','2'),'status'=>'active','disabled'=>'false','order_type|in'=>array('largeCustomer')))),
            3=>array('label'=>app::get('b2c')->_('已发货'),'optional'=>false,'filter'=>array_merge($order_filter,array('ship_status'=>array('1'),'status'=>'active','disabled'=>'false','order_type|in'=>array('largeCustomer')))),
            4=>array('label'=>app::get('b2c')->_('已完成'),'optional'=>false,'filter'=>array_merge($order_filter,array('status'=>'finish','disabled'=>'false','order_type|in'=>array('largeCustomer')))),
            5=>array('label'=>app::get('b2c')->_('已退款'),'optional'=>false,'filter'=>array_merge($order_filter,array('pay_status'=>array('4','5'),'status'=>'active','disabled'=>'false','order_type|in'=>array('largeCustomer')))),
            6=>array('label'=>app::get('b2c')->_('已退货'),'optional'=>false,'filter'=>array_merge($order_filter,array('ship_status'=>array('3','4'),'status'=>'active','disabled'=>'false','order_type|in'=>array('largeCustomer')))),
            7=>array('label'=>app::get('b2c')->_('已作废'),'optional'=>false,'filter'=>array_merge($order_filter,array('status'=>'dead','disabled'=>'false','order_type|in'=>array('largeCustomer')))),
        );
        //新留言订单
        ...
        foreach($sub_menu as $k=>$v){
            if($v['optional']==false){
                ...
                $show_menu[$k]['href'] = 'index.php?app=cardcoupons&ctl=admin_lcorder&act='.$act.'&view='.($k).(isset($_GET['optional_view'])?'&optional_view='.$_GET['optional_view'].'&view_from=dashboard':'');
