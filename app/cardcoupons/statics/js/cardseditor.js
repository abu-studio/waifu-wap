var ShopExGoodsEditor = new Class({
    ...
    updateEditorBody:function(options){
       ...
       var parma={
            ...
            url:'index.php?app=cardcoupons&ctl=admin_cards_editor&act=update',
            evalScripts:false,
    ...
    mprice:function(e){
        ...
        window.fbox = new Dialog('index.php?app=cardcoupons&ctl=admin_cards_editor&act=set_mprice',{title:LANG_goodseditor['editvipprice'], ajaxoptions:{data:info,method:'post'},modal:true});
    ...
    adj:{
        addGrp:function(s){
            this.dialog = new Dialog('index.php?app=cardcoupons&ctl=admin_cards_editor&act=addGrp&goods_id='+this.goods_id+'&_form='+(s?s:'goods-adj'), {title:LANG_goodseditor['widget']});
        }
    },
    pic:{
        del:function(obj){
