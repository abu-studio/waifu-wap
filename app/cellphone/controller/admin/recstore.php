<?php
 ...
 class cellphone_ctl_admin_recstore extends desktop_controller{
	 ...
	 $this->finder('cellphone_mdl_recstore',
		    array('actions' =>array(
                  array(
                    'label' => app::get('cellphone')->_('添加推荐店铺'),
                    'icon' => 'add.gif',
                  ...
                  array('label' => "批量操作",
                        ...
                        'group' => array(
                            ...
                            array('label' => app :: get('cellphone') -> _('排序'), 'icon' => 'download.gif', 'submit' => 'index.php?app=cellphone&ctl=admin_recstore&act=singleBatchEdit&p[0]=dorder', 'target' => 'dialog'),
					                    ),
                        ),
