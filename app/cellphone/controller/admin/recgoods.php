<?php
 ...
 class cellphone_ctl_admin_recgoods extends desktop_controller{
	...
	$this->finder('cellphone_mdl_recgoods',
		array('actions' =>array(
                  array(
                    'label' => app::get('cellphone')->_('添加推荐商品'),
                    'icon' => 'add.gif',
				   ...
				   array('label' => "批量操作",
                        ...
                        'group' => array(
                            ...
                            array('label' => app :: get('cellphone') -> _('排序'), 'icon' => 'download.gif', 'submit' => 'index.php?app=cellphone&ctl=admin_recgoods&act=singleBatchEdit&p[0]=dorder', 'target' => 'dialog'),
					               ),
                        ),
                 ),
		    	'title'=>'推荐商品列表',
