<?php
 ...
 class cellphone_ctl_admin_column extends desktop_controller{
	 ...
	 $type = $columntype->getList('columntype_id,columntype_name',array('type'=>'column'));
    ...
    function saveBatchEdit() { 
	  ...
	  function changeType(){
	   ...
	   if($select_type == "goods"){
        echo $render->fetch('admin/column/goods.html');
	   }
	   if($select_type == "brand"){
        echo $render->fetch('admin/column/brand.html');
	   }
