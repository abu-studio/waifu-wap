...
/**
 * 预存款支付具体实现，实际内容与标准版相同
 * @auther shopex ecstore dev dev@shopex.cn
 * @version 0.1
 * @package ectools.lib.payment.plugin
 */
final class cellphone_payment_plugin_deposit extends ectools_payment_app implements ectools_interface_payment_app{
	/**
	 * @var string 支付方式名称
	 */
	public $name = '预存款支付-客户端版';
	/**
     * @var string 支付方式接口名称
     */
    public $app_name = '预存款支付接口-客户端版';
    /**
     * @var string 支付方式key
     */
	 ...
	 * @var string 统一显示的名称
	 */
    public $display_name = '预存款支付-客户端版';
    /**
	 * @var string 货币名称
	 */
    public $curname = 'CNY';
