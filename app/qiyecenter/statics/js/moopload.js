 ...
 credits Based off of File.Upload by Matthew Loberg and MooTools-Form-Upload (httpsgithub.comarianmootools-form-upload) by Arian Stolwijk
...
Moopload = new Class({
    ...
    onComplete function(){
      ...
      Add keyvalue pair of textual data to send together with files.
      @param data array
    ...
    addData function(data){
      ...
      Clear extra textual data send as part of the url. Basically resets the url back to the originalinitial value
