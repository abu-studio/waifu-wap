(function(){
    var ModeDialog=this.ModeDialog=new Class({
        ...
        options: {
            ...
            iTop : window.screen.height*0.1/2,
            iLeft : window.screen.width*0.2/2,
            resizable:true
        },
        initialize:function(url,options){
            ...
            var config="modal=true,width={width}px,height={height}px,resizable={resizable},top={iTop},left={iLeft},status=no";
