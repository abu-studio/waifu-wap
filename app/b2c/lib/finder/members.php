...
class b2c_finder_members{
	...
	var $column_company_no;
	var $column_company_name;
    var $pagelimit = 10;
    ...
    public function __construct($app)
    {
		...
		$this->column_company_no = app::get('b2c')->_('商社编号');
		$this->column_company_name = app::get('b2c')->_('商社名称');
    }
	...
	public function column_company_no($row)
    {
		...
		$info = $pam->getRow('company_no',array('account_id'=>$row['member_id']));
		return $info['company_no'];
    }
	
	public function column_company_name($row)
    {
        $pam = app::get('pam')->model('account');
		$info = $pam->getRow('company_name',array('account_id'=>$row['member_id']));
