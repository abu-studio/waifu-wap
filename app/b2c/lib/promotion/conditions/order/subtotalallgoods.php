...
class b2c_promotion_conditions_order_subtotalallgoods{
    ...
    <input type="text" style="border: 1px solid;margin-left:2px;text-align:center;" name="conditions[conditions][0][value]" size="3" vtype="required&&unsigned" value="{$aData['conditions']['conditions'][0]['value']}" />
