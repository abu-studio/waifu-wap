...
class b2c_promotion_conditions_order_subtotalselectgoods{
    ...
    <input type="text" name="conditions[conditions][0][value]" style="border: 1px solid;margin-left:2px;text-align:center;" size="3" vtype="required&&digits" value="{$aData['conditions'][0]['value']}" />
EOF;
                break;
        }
    }
