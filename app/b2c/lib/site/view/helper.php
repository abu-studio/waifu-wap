...
class b2c_site_view_helper
{
    ...
    {
        if($smarty->app->app_id != 'b2c' && $smarty->app->app_id != 'groupbuy' && $smarty->app->app_id != 'gift' && $smarty->app->app_id != 'business' && $smarty->app->app_id != 'timedbuy' && $smarty->app->app_id != 'scorebuy' && $smarty->app->app_id != 'spike' && $smarty->app->app_id != 'package'){
            return "";
        }
