...
class b2c_ctl_admin_member_attr extends desktop_controller{
	...
	*/
    ...
    function setTime(){
        ...
        $this->pagedata['to_check_orders_time'] = $this->app->getConf('site.to_check_orders_time');
    ...
    function updateTime(){
        ...
        $this->app->setConf('site.to_check_orders_time',$_POST['to_check_orders_time']);
    ...
    function setService(){
        ...
        $this->pagedata['ServiceTel'] = $this->app->getConf('member.ServiceTel');
    ...
    function updateService(){
        ...
        $this->app->setConf('member.ServiceTel',$_POST['ServiceTel']);
        $this->end(true,app::get('b2c')->_('设置成功'));  
    }
