...
//echo '</pre>';
        ...
        $this->pagedata['pager'] = array(
            ...
            'link'=>  $this->gen_url(array('app'=>'b2c', 'ctl'=>'site_gallery','full'=>1,'act'=>'index','args'=>array( ($cat_type?$old_cat_id:implode(',',$cat_id) ),urlencode($p['str']),$orderBy,$tab,($tmp=time()),$cat_type,$view,$st,$tmpl))),//.'?scontent='.urlencode($p['str']),
            'token'=>$tmp);
