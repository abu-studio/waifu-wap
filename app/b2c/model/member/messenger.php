...
class b2c_mdl_member_messenger {
    ...
    function actions(){
        $actions = array(
            ...
            'orders-exchange'=>array('label'=>app::get('b2c')->_('卡券兑换时'),'level'=>9,'varmap'=>app::get('b2c')->_('订单号').'&nbsp;<{$order_id}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('付款人').'&nbsp;<{$pay_account}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('付款时间').'&nbsp;<{$pay_time}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('付款金额').'&nbsp;<{$money}>','isIndex'=>1//前后台控制发送的表示0为后台1为前台
            ),
           ...
           'orders-ship'=>array('label'=>app::get('b2c')->_('买家发货申请'),'level'=>9,'varmap'=>app::get('b2c')->_('登录名').'&nbsp;<{$uname}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('订单号').'&nbsp;<{$order_id}>&nbsp;&nbsp;&nbsp;&nbsp;','isIndex'=>0
            ),
            ...
            'cardcoupons_orders'=>array('label'=>app::get('b2c')->_('卡券订单信息'),'level'=>9,'varmap'=>app::get('b2c')->_('用户名').'&nbsp;<{$uname}>&nbsp;&nbsp;&nbsp;&nbsp;','isIndex'=>0
            ),

            'physical-create'=>array('label'=>app::get('b2c')->_('体检预约模版'),'level'=>9,'varmap'=>app::get('b2c')->_('用户名').'&nbsp;<{$uname}>&nbsp;&nbsp;&nbsp;&nbsp;','isIndex'=>0
            ),
    ...
    function getCardMessage($tmpl_name,$data){
