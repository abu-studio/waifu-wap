...
class complain_ctl_site_buyer_complain extends b2c_ctl_site_member
{
    ...
    public function addSave(){
        ...
        $error_url = $this->gen_url(array('app' => 'complain','ctl' => 'site_buyer_complain', 'act'=>'add','arg0'=>$obj_filter->check_input($_POST['from_member_id']),'arg1'=>$obj_filter->check_input($_POST['order_id']),'arg2'=>$obj_filter->check_input($_POST['store_id'])));
        ...
        $data['order_id']=$obj_filter->check_input($_POST['order_id']);
        $data['from_member_id']=$obj_filter->check_input($_POST['from_member_id']);
        $data['to_member_id']=$obj_filter->check_input($_POST['to_member_id']);
        $data['source']=$obj_filter->check_input($_POST['source']);
        ...
        $data['from_uname']=$obj_filter->check_input($_POST['from_uname']);
        $data['to_uname']=$obj_filter->check_input($_POST['to_uname']);
        $data['reason']=$obj_filter->check_input($_POST['reason']);
        $data['memo']=$obj_filter->check_input($_POST['memo']);
