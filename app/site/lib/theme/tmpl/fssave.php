...
class site_theme_tmpl_fssave 
{
    ...
    private function __get_tmpl_list() {
        $ctl = array(
            ...
            'lost'=>app::get('site')->_('忘记密码页'),
            'member'=>app::get('site')->_('会员中心页'),
            'member_main'=>app::get('site')->_('会员主页面'),
			...
			'activelist'=>app::get('site')->_('活动列表页'),
            'investment'=>app::get('site')->_('招商首页'),
            'default'=>app::get('site')->_('默认页'),
            'index_default'=>app::get('site')->_('我的首页'),
            'business'=>app::get('site')->_('商家中心页'),
            'shuidianmei'=>app::get('site')->_('水电煤页面'),
			'physical'=>app::get('site')->_('体检首页'),
			'physical_public'=>app::get('site')->_('体检公用页面'),
			'exchange'=>app::get('site')->_('体检兑换流程页面'),
            'card_default'=>app::get('site')->_('卡券兑换'),
			'card_channel'=>app::get('site')->_('卡券频道'),
			'card_detail'=>app::get('site')->_('卡券详情页'),
			'card_main'=>app::get('site')->_('卡券选择页面'),
            'qiyecenter_main'=>app::get('site')->_('企业主页面'),
            'qiyecenter'=>app::get('site')->_('企业页面'),
			'cardex_detail'=>app::get('site')->_('卡券兑换商品详情页'),
			'login1'=>app::get('site')->_('登录页1'),
			'card_default1'=>app::get('site')->_('卡券兑换1'),
			'card_main1'=>app::get('site')->_('卡券选择页面1'),
			'cardex_detail1'=>app::get('site')->_('卡券兑换商品详情页1'),
			'exchange1'=>app::get('site')->_('体检兑换流程页面1'),
			'overseas'=>app::get('site')->_('海外购页面'),
			'jdsale'=>app::get('site')->_('京东商品列表页面'),
			'jdproduct'=>app::get('site')->_('京东商品详情页面'),
            'hfgallery'=>app::get('site')->_('和风频道商品列表页'),
            'hfproduct'=>app::get('site')->_('和风商品详情页面'),
            'hfcart'=>app::get('site')->_('和风购物车页'),
            'hfjdproduct'=>app::get('site')->_('和风频道京东商品详情页面'),
        );
