...
class site_controller extends base_controller
{
    ...
    function __construct(&$app)
    {
        ...
        $this->app = $app;
		$flag = app::get('desktop')->getConf('site.maintenance');
		if($flag){
			$this->pagedata['url']=kernel::base_url(1).'/app/site/view/maintenance';
			$this->display('maintenance/maintenance.html','site');
			exit;
		}
    ...
    {
        $from = array(
            '/((?:background|src|href)\s*=\s*["|\'])(?:\.\/|\.\.\/)?([images\/|pic\/].*?["|\'])/is',
