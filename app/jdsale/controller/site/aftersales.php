...
class jdsale_ctl_site_aftersales extends b2c_ctl_site_member{
    ...
    public function index($order_id){
        $order_skus_url = array('app' => 'jdsale','ctl' => 'site_aftersales','act'=>'order_skus','arg0'=>$order_id);
    ...
    public function save_apply(){
        ...
        $sucess_url = array('app' => 'jdsale','ctl' =>'site_aftersales','act'=>'service_list',
                            'arg0'=>$_POST['jdOrderId'],'arg1'=>$_POST['order_id'],'arg2'=>$hasSubOrder );
        $failed_url = array('app' => 'jdsale','ctl' => 'site_aftersales', 'act'=>'order_skus' ,
                            'arg0'=>$_POST['order_id']);
        $this->begin();
    ...
    public function cancel_apply($afsServiceId,$jdOrderID,$order_id){
        $this->begin(array('app' => 'jdsale','ctl' => 'site_aftersales', 'act'=>'service_list' ,
    ...
    private function return_save($apply){
