...
class jdsale_ctl_admin_order extends desktop_controller{
	...
	public function _views(){
        ...
        foreach($sub_menu as $k=>$v){
            if($v['optional']==false){
                ...
                $show_menu[$k]['href'] = 'index.php?app=jdsale&ctl=admin_order&act='.$act.'&view='.($k).(isset($_GET['optional_view'])?'&optional_view='.$_GET['optional_view'].'&view_from=dashboard':'');
