...
//                        array('label' => app::get('b2c')->_('批量发布宝贝'), 'app' => 'business', 'ctl' => 'site_member', 'link' => 'goods_import'),
                ...
                array('label' => app::get('b2c')->_('店铺管理'),
				 ...
				 array('label' => app::get('business')->_('结算中心'),
                    'mid' => 12,
                    'items' => array(
                        array('label' => app :: get('business') -> _('结算报表'), 'app' => 'business', 'ctl' => 'site_member', 'link' => 'settlement_list'),
                        )
                    ),
                    ...
                    array('label' => app::get('b2c')->_('营销中心'),
                        ...
                        'items'=>array(
                         //   array('label' => app::get('b2c')->_('优惠券'), 'app' => 'business', 'ctl' => 'site_store', 'link' => 'storecoupon'),
                           array('label' => app::get('b2c')->_('订单促销'), 'app' => 'business', 'ctl' => 'site_promotion', 'link' => 'order'),
				...
				//判断店铺是否为京东商品专营店铺
				$sto= kernel::single("business_memberstore",app::get('b2c')->member_id);
				$sto->process(app::get('b2c')->member_id);
				$data = $sto->storeinfo;
				if(app::get('site')->getConf('jdsale.shopId') == $data['store_id']){
					$arr_extends = $jd_arr_extends;
				}
